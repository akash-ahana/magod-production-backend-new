...
machineSetup.post('/saveMachine', jsonParser ,  async (req, res, next) => {
    //console.log('request to save machine' ,  req.body)
   ...
   // console.log(req.body.InstallDate)
    ...
    if(req.body.UnistallDate === '' && req.body.InstallDate!='') {
       // console.log(' Only Uninstall date is empty')
        try {
            mchQueryMod(`UPDATE machine_data.machine_list SET remarks='${req.body.remarks}' , InstallDate='${req.body.InstallDate}' ,  TgtRate='${req.body.TgtRate}' , Working='${req.body.Working}' , location='${req.body.location}' , RegnNo='${req.body.RegnNo}'  WHERE refName='${req.body.refName}'`, (err, data) => {
                if (err) logger.error(err);
                res.send(data)
            })
        } catch (error) {
       ...
       // console.log('only  Install date is empty')
        try {
            mchQueryMod(`UPDATE machine_data.machine_list SET remarks='${req.body.remarks}' , UnistallDate='${req.body.UnistallDate}' ,  TgtRate='${req.body.TgtRate}' , Working='${req.body.Working}' , location='${req.body.location}' , RegnNo='${req.body.RegnNo}'  WHERE refName='${req.body.refName}'`, (err, data) => {
                if (err) logger.error(err);
                res.send(data)
            })
        } catch (error) {
      ...
      //  console.log('both Install Date and Uninstall date is empty')
        try {
            mchQueryMod(`UPDATE machine_data.machine_list SET remarks='${req.body.remarks}' ,  TgtRate='${req.body.TgtRate}' , Working='${req.body.Working}' , location='${req.body.location}' , RegnNo='${req.body.RegnNo}'  WHERE refName='${req.body.refName}'`, (err, data) => {
                if (err) logger.error(err);
                res.send(data)
            })
        } catch (error) {
      ...
      //  console.log('Both Install Date and Uninstall  are present')
        try {
            mchQueryMod(`UPDATE machine_data.machine_list SET remarks='${req.body.remarks}' ,InstallDate='${req.body.InstallDate}' , UnistallDate='${req.body.UnistallDate}' , TgtRate='${req.body.TgtRate}' , Working='${req.body.Working}' , location='${req.body.location}' , RegnNo='${req.body.RegnNo}'  WHERE refName='${req.body.refName}'`, (err, data) => {
                if (err) logger.error(err);
                res.send(data)
            })
        } catch (error) {
...
machineSetup.get('/getAllProcessList', jsonParser , async (req, res, next) => {
    //console.log(req.body)
    try {
        mchQueryMod(`select * from machine_data.magod_process_list`, (err, data) => {
            if (err) logger.error(err);
            res.send(data)
        })
    } catch (error) {
...
machineSetup.post('/addProcessToMachine', jsonParser , async (req, res, next) => {
   // console.log('Add Process To Machine' , req.body)
    try {
        mchQueryMod(`INSERT INTO machine_data.machine_process_list(Machine_srl ,Mprocess , RefProcess , TgtRate) VALUES ( '${req.body.Machine_srl}' , '${req.body.Mprocess}',  '${req.body.RefProcess}' , '${req.body.TgtRate}')`, (err, data) => {
            if (err) logger.error(err);
            res.send(data)
        })
    } catch (error) {
...
machineSetup.post('/getProcessForMachine', jsonParser , async (req, res, next) => {
  ...
  //  console.log('Get Process For Machine' , req.body)
    ...
    try {
        mchQueryMod(`select * from machine_process_list where Machine_srl='${req.body.Machine_srl}'`, (err, data) => {
            if (err) logger.error(err);
            res.send(data)
        })
    } catch (error) {
...
machineSetup.post('/deleteProcessFromMachine', jsonParser , async (req, res, next) => {
    //console.log(req.body)
    try {
        mchQueryMod(`delete from machine_process_list where Machine_srl='${req.body.Machine_srl}' and Mprocess='${req.body.Mprocess}'`, (err, data) => {
            if (err) logger.error(err);
            res.send(data)
        })
    } catch (error) {
